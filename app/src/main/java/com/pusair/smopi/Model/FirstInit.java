...
public class FirstInit {
    ...
    @Expose
    @SerializedName("staf_ppa_mantri")
    List<User> staffPpaMantriList;
    ...
    public List<User> getStaffPpaMantriList() {
        return staffPpaMantriList;
    }

    public void setStaffPpaMantriList(List<User> staffPpaMantriList) {
        this.staffPpaMantriList = staffPpaMantriList;
    }
